...
export default function ClassAnnouncementsView({
  ...
  // Auto-open a specific announcement when navigated from notifications
  useEffect(() => {
    if (!openId) return;
    const found = announcements.find((a) => Number(a.id) === openId);
    if (found) {
    ...
    <PageTransition>
      ...
      >
        ...
        {announcements.length === 0 ? (
          <GlassEmptyState message="No announcements found for this course." />
        ) : (
