          ...
          >
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs" style={{ color: 'var(--color-muted)' }}>
                  {(status as { needsRenewal: true; daysUntilExpiry: number }).daysUntilExpiry > 0
                    ? `Expires in approximately ${(status as { needsRenewal: true; daysUntilExpiry: number }).daysUntilExpiry} day${(status as { needsRenewal: true; daysUntilExpiry: number }).daysUntilExpiry === 1 ? '' : 's'}`
            ...
            <p className="text-sm mb-5" style={{ color: 'var(--color-muted)' }}>
              ...
              <span style={{ color: 'var(--color-text)' }}>
                {(status as { needsRenewal: true; daysOld: number }).daysOld} days ago
              </span>{' '}
